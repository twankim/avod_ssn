...
CONFIG_MAIN=avod/configs/lel/lowres_4_full/trainsinalt_pyramid_cars_with_aug_lel_lowres_4_full.config
CONFIG_EVALSIN=avod/configs/lel/lowres_4_full/trainsinalt_pyramid_cars_with_aug_lel_evalsin_lowres_4_full.config
CONFIG_EVALAIN=avod/configs/lel/lowres_4_full/trainsinalt_pyramid_cars_with_aug_lel_evalain_lowres_4_full.config
