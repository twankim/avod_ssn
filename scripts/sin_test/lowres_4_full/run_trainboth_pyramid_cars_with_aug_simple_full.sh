...
CONFIG_MAIN=avod/configs/simple/lowres_4_full/trainboth_pyramid_cars_with_aug_simple_lowres_4_full.config
CONFIG_EVALSIN=avod/configs/simple/lowres_4_full/trainboth_pyramid_cars_with_aug_simple_evalsin_lowres_4_full.config
CONFIG_EVALAIN=avod/configs/simple/lowres_4_full/trainboth_pyramid_cars_with_aug_simple_evalain_lowres_4_full.config
