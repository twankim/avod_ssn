...
CONFIG_MAIN=avod/configs/concat/rand_5/trainboth_pyramid_cars_with_aug_concat_rand_5.config
CONFIG_EVALSIN=avod/configs/concat/rand_5/trainboth_pyramid_cars_with_aug_concat_evalsin_rand_5.config
CONFIG_EVALAIN=avod/configs/concat/rand_5/trainboth_pyramid_cars_with_aug_concat_evalain_rand_5.config
