...
CONFIG_MAIN=avod/configs/simple/rand_5/trainsinalt_pyramid_cars_with_aug_simple_rand_5.config
CONFIG_EVALSIN=avod/configs/simple/rand_5/trainsinalt_pyramid_cars_with_aug_simple_evalsin_rand_5.config
CONFIG_EVALAIN=avod/configs/simple/rand_5/trainsinalt_pyramid_cars_with_aug_simple_evalain_rand_5.config
