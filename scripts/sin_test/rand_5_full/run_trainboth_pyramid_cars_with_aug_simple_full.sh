...
CONFIG_MAIN=avod/configs/simple/rand_5_full/trainboth_pyramid_cars_with_aug_simple_rand_5_full.config
CONFIG_EVALSIN=avod/configs/simple/rand_5_full/trainboth_pyramid_cars_with_aug_simple_evalsin_rand_5_full.config
CONFIG_EVALAIN=avod/configs/simple/rand_5_full/trainboth_pyramid_cars_with_aug_simple_evalain_rand_5_full.config
