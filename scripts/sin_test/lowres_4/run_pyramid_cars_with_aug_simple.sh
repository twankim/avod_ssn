...
CONFIG_EVALSIN=avod/configs/simple/lowres_4/pyramid_cars_with_aug_simple_evalsin_lowres_4.config
CONFIG_EVALAIN=avod/configs/simple/lowres_4/pyramid_cars_with_aug_simple_evalain_lowres_4.config
